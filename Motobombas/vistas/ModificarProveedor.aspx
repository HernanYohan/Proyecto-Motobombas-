...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" CssClass="auto-style2" Text="Modificar Proveedor"></asp:Label>
                ...
                <asp:ObjectDataSource ID="proveedor" runat="server" DeleteMethod="eliminarproveedor" SelectMethod="obtenerproveedor" TypeName="Dao_proveedor" UpdateMethod="modificarproveedor">
                    <DeleteParameters>
