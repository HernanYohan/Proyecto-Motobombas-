    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style8">
                ...
                <asp:ObjectDataSource ID="producto" runat="server" DeleteMethod="eliminarProducto" SelectMethod="obtenerproducto" TypeName="Dao_Motobombas"  UpdateMethod="modificarProducto">
                    <DeleteParameters>
