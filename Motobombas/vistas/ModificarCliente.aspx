    ...
    <table class="auto-style2" align="center">
        <tr>
            <td class="auto-style3">
                ...
                <br />
                <asp:ObjectDataSource ID="Cliente" runat="server" DeleteMethod="eliminarCliente" SelectMethod="obtenercliente" TypeName="Dao_Cliente" UpdateMethod="modificarcliente">
                    <DeleteParameters>
