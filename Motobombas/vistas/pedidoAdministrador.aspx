    ...
    <table class="auto-style1" style="margin-left: 0px; margin-top: 55px; background-color: #000066">
        ...
        <tr>
            ...
            <td class="auto-style17">
                <asp:TextBox ID="TB_cantidad" runat="server" MaxLength="6" TextMode="Number" Visible="False" Width="70px"></asp:TextBox>
            ...
            <td class="auto-style9">
                <asp:GridView ID="GV_selec" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="select" ForeColor="#333333" GridLines="None" OnRowCommand="GV_selec_RowCommand" OnSelectedIndexChanged="GV_selec_SelectedIndexChanged">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                <asp:Button ID="B_pedido" runat="server" CommandArgument ='<%# Bind("id_proveedor") %>  ' CommandName="B_pedido" OnClick="B_pedido_Click" style="color: #FFFFFF; text-align: left; font-size: medium; background-color: #000099" Text="Realizar pedido" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
            ...
            <td class="auto-style9">
                <asp:ObjectDataSource ID="select" runat="server" SelectMethod="seleccionar" TypeName="Dao_proveedor">
                    <SelectParameters>
                        <asp:SessionParameter Name="referencia" SessionField="referencia" Type="String" />
                    </SelectParameters>
                </asp:ObjectDataSource>
            </td>
        </tr>
